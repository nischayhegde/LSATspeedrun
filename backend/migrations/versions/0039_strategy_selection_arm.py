...
SINGLE HEAD. `down_revision` is `0038_question_type_source`, added on the same
branch. If a sibling revision lands on 0038 first, renumber this one and move
`down_revision` to the end of the chain; nothing here depends on ordering
beyond being after the tables it alters exist.
