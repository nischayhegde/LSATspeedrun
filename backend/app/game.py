...
_DISTRICTS: list[dict] = [
    ...
    {"key": "diplomatic_quay", "region": "ocean", "name": "The Diplomatic Quay", "landmark": "ocean-quay", "tier": 7, "reputation": 68, "cases": .65, "retainer": "the harbour authority", "description": "Where delegations come ashore. The authority wants one firm on call for everything that goes wrong before the talks begin."},
    {"key": "bonded_roads", "region": "ocean", "name": "The Bonded Roads", "landmark": "ocean-roads", "tier": 7, "reputation": 69, "cases": .60, "retainer": "the bonded warehouses", "description": "Cargo that is legally nowhere until someone signs for it. An entire practice lives in that gap."},
    {"key": "chandlers_row", "region": "ocean", "name": "Chandler's Row", "landmark": "ocean-chandlers", "tier": 8, "reputation": 74, "cases": .60, "retainer": "the ships' agents", "description": "Every agent on the row keeps a lawyer's name in a drawer for the day a master refuses to sail."},
    {"key": "lantern_light", "region": "ocean", "name": "The Lantern Light", "landmark": "ocean-lantern", "tier": 8, "reputation": 75, "cases": .50, "retainer": "the pilots' board", "description": "Pilotage is compulsory, which means pilotage is litigated. The board has never had counsel who understood both."},
    {"key": "treaty_anchorage", "region": "ocean", "name": "Treaty Anchorage", "landmark": "ocean-anchorage", "tier": 9, "reputation": 79, "cases": .70, "retainer": "the anchorage compact", "description": "Neutral water by agreement only. The agreement is the practice."},
    {"key": "free_harbour_court", "region": "ocean", "name": "Free Harbour Court", "landmark": "ocean-court", "tier": 9, "reputation": 80, "cases": .80, "retainer": "the admiralty roll", "description": "The sea's own courthouse. A place on the roll is the closest thing the Treaty Sea has to a permanent address."},
    ...
    {"key": "compact_concourse", "region": "orbit", "name": "The Compact Concourse", "landmark": "orbit-concourse", "tier": 12, "reputation": 89, "cases": .70, "retainer": "the delegations' desk", "description": "Every signatory keeps a bench here. Being the desk's standing counsel means being in the room before the room convenes."},
    {"key": "hearing_chamber_one", "region": "orbit", "name": "Hearing Chamber One", "landmark": "orbit-chamber", "tier": 12, "reputation": 90, "cases": .85, "retainer": "the chamber list", "description": "The list decides who is heard and in what order. Nothing in this game is worth more and costs less to hold."},
    {"key": "registry_vault", "region": "orbit", "name": "The Registry Vault", "landmark": "orbit-registry", "tier": 13, "reputation": 92, "cases": .70, "retainer": "the compact registry", "description": "Where every treaty in force is actually kept. Custody is a duty, and duties are retained."},
    {"key": "far_side_landing", "region": "orbit", "name": "Far-Side Landing", "landmark": "orbit-landing", "tier": 13, "reputation": 92, "cases": .65, "retainer": "the landing authority", "description": "The furthest place a writ has ever been served, and the authority would rather it were served by you."},
    {"key": "assembly_gallery", "region": "orbit", "name": "The Assembly Gallery", "landmark": "orbit-gallery", "tier": 14, "reputation": 94, "cases": .80, "retainer": "the gallery secretariat", "description": "Public seats at a private negotiation. The secretariat needs someone who can say no to the powerful in writing."},
    {"key": "founders_reading_room", "region": "orbit", "name": "The Founders' Reading Room", "landmark": "orbit-reading-room", "tier": 14, "reputation": 95, "cases": .65, "retainer": "the charter trustees", "description": "Nine chairs and the original charter. There is no larger room to be invited into."},
]
